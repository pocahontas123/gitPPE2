<?php
	...
	/*Si j'ai déjà mes superglobale de SESSION['idEmploye'] et 'mdp', je n'ai rien à faire sur connexion.php
	...
	*/
	...
	if( !empty( $_POST ) ) {
		...
		extract( $_POST );
		//Je relie mon fichier qui contient toutes mes fonctions (account_exist et ident_libre)

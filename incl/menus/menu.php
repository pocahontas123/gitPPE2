		...
		<nav class="navbar bg-primary">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand">PPE 2| <span style="margin-left: 300px;">Application web : Maison des ligues</span></a>
				</div>
							...
							<div class="btn-group">
								<div class="container-fluid">
									<div class="row">
										...
										<?php $data = getNomJoursCredit($_SESSION['idEmploye']); ?>
										...
										<button id="button_menu" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<i class="fa fa-bars fa-2x" aria-hidden="false"></i> Bienvenu <strong><?= $data[0]['nomEmploye'].' '.$data[0]['prenomEmploye']; ?></strong><span class="caret"></span>
										</button>
		...
		<nav>
			<ol class="breadcrumb">
				...
				<?php
					...
					//visible uniquement par un chef
					if( $typeEmploye == 2 ) {?>		
					
					<li><a href="index.php?formation=5">Mes employés</a></li>

		...
		<table class="table table-hover">
			...
			<tbody>
				<tr>
					...
					<td><a href="index.php?idFormation=<?= $formations['idFormation'] ;?>&formation=4&inscription=0"><i><button class="btn btn-primary">Désinscription</button></i></a></td>
					<?php } else { ?>
					<td><a href="index.php?idFormation=<?= $formations['idFormation'] ;?>&formation=4&inscription=1"><i><button class="btn btn-primary">inscription</button></i></a></td>
					<?php } ?>
				</tr>
			</tbody>
		</table>
